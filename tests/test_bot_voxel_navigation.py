...
def test_double_dragon_production_brain_drives_real_spawned_players() -> None:
    ...
    async def scenario() -> None:
        ...
        try:
            ...
            # on every architecture. A dedicated native-body recovery test
            # above proves the route reaches land; this fixed-duration scenario
            # may legitimately stop partway through that bounded recovery.
