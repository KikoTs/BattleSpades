...
def test_default_loadouts_match_client():
    ...
    expect = [
        ...
        (2,  C.SMG_TOOL, C.ROCKET_TURRET_TOOL, C.JETPACK2, C.SPADE_TOOL, C.JETPACK2),
        (12, C.SMG_TOOL, C.ROCKET_TURRET_TOOL, C.JETPACK_ENGINEER, C.PICKAXE_TOOL, C.JETPACK_ENGINEER),
        (13, C.UGC_DRILLGUN_TOOL, C.UGC_SNOWBLOWER_TOOL, C.JETPACK_UGCBUILDER, C.UGC_SUPERSPADE_TOOL, C.JETPACK_UGCBUILDER),
