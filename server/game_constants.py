...
_CATALOG_LIST = [
    ...
    # PISTOL: client values are fire 0.4 (A1120), reload 0.6 (A1119),
    # head 45 (A1125), range 550 (A1118). We had 0.3 / 0.5 / 50 / 800.
    _gun(17, "PISTOL",            CAT_PISTOL,  20, 45,  0.4,  6, 30,  0.6, 1, 550,   3),
    ...
    _proj(54, "CHEMICALBOMB",          CAT_GRENADE,  0,   0, 1.0,  4, 0, 0.0, 0, 0.0),
    _proj(55, "GRENADE_LAUNCHER_WEAPON", CAT_LAUNCHER, 0, 0, 0.35, 1, 5, 2.0, 0, 0.0),
    _proj(57, "STICKY_GRENADE",        CAT_GRENADE,  0,   0, 1.0,  4, 0, 0.0, 0, 0.0),
    _proj(58, "MINE_LAUNCHER",         CAT_LAUNCHER, 0,   0, 0.35, 1, 5, 2.0, 0, 0.0),
    _proj(59, "C4",                    CAT_DEPLOYABLE, 0, 0, 1.0,  2, 0, 0.0, 0, 0.0),
